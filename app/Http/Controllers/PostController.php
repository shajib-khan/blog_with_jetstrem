...
class PostController extends Controller
{
    ...
    {
        return view('components.dashboard.posts.index');
    }
    ...
    {
        return view('components.dashboard.posts.create', [
            'tags'          => Tag::all(),
    ...
    public function edit(Post $post)
    {
        ...
        return view('components.dashboard.posts.edit', compact('post', 'tags', 'categories', 'oldTags'));
    }
